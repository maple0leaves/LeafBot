...
from leafbot.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
from leafbot.agent.tools.web import WebFetchTool, WebSearchTool
from leafbot.bus.events import InboundMessage, OutboundMessage
from leafbot.bus.queue import MessageBus
from leafbot.providers.base import LLMProvider
from leafbot.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from leafbot.config.schema import ChannelsConfig, ExecToolConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from leafbot.config.schema import ExecToolConfig
        self.bus = bus
    ...
    def _register_default_tools(self) -> None:
        ...
        self.tools.register(WebSearchTool(api_key=self.brave_api_key, tavily_api_key=self.tavily_api_key, proxy=self.web_proxy))
    ...
    async def _connect_mcp(self) -> None:
        ...
        from leafbot.agent.tools.mcp import connect_mcp_servers
        try:
