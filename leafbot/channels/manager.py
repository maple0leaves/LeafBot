...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.telegram.enabled:
            try:
                from leafbot.channels.telegram import TelegramChannel
        ...
        if self.config.channels.discord.enabled:
            try:
                from leafbot.channels.discord import DiscordChannel
        ...
        if self.config.channels.mochat.enabled:
            try:
                from leafbot.channels.mochat import MochatChannel
        ...
        if self.config.channels.dingtalk.enabled:
            try:
                from leafbot.channels.dingtalk import DingTalkChannel
        ...
        if self.config.channels.matrix.enabled:
            try:
                from leafbot.channels.matrix import MatrixChannel
