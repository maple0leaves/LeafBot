...
class AgentDefaults(Base):
    ...
    workspace: str = "~/.leafbot/workspace"
...
class WebSearchConfig(Base):
    ...
    tavily_api_key: str = ""  # Tavily Search API key (fallback when Brave fails)
    max_results: int = 5
...
class Config(BaseSettings):
    """Root configuration for leafbot."""
    ...
    model_config = ConfigDict(env_prefix="LEAFBOT_", env_nested_delimiter="__")
