...
from leafbot.cli import commands
...
def mock_prompt_session():
    ...
    with patch("leafbot.cli.commands._PROMPT_SESSION", mock_session), \
         patch("leafbot.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("leafbot.cli.commands.PromptSession") as MockSession, \
         patch("leafbot.cli.commands.FileHistory") as MockHistory, \
